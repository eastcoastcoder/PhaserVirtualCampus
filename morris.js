...
function preload() {
    ...
    game.load.tilemap('map', 'assets/tilemaps/maps/morris.json', null, Phaser.Tilemap.TILED_JSON);
...
function create() {
    ...
    player = game.add.sprite(1450, 1100, 'player', 1);
    ...
    var mapname = game.add.text(16, 16, 'Morris Area', { font: '14px Arial', fill: '#000000' });
